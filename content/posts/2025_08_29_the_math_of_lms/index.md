...
cover:
  image: "images/posts/2025_08_29_the_math_of_lms/example.png"
---
...
{{< figure id="vector_notation.png" src="./vector_notation.png" alt="vector_notation" caption="Vector notation" width="800"  >}}
...
{{< figure id="example.png" src="./example.png" alt="example" caption="Attention example" width="800"  >}}
...
Given two vectors $\textbf{q}, \textbf{k} \in \mathbb{R}^{1,d_k}$, their dot product is defined as:

$$
\textbf{q} \cdot \textbf{k} = \sum_{i=1}^n q_i v_i
$$

$$
\begin{align*}\textbf{q}\cdot\textbf{k}  &= \underbrace{q_1v_1 + q_2v_2 + q_3v_3}_{\text{sum form}} \\[6pt]  &= \begin{bmatrix} 1 \\ 2 \\ 3 \end{bmatrix} \!\cdot\!     \begin{bmatrix} 4 \\ 5 \\ 6 \end{bmatrix}     \;=\; 1\!\cdot\!4 + 2\!\cdot\!5 + 3\!\cdot\!6     \;=\; 32                                   \quad     \bigl\lbrace\text{numeric example}\bigr\rbrace\end{align*}
$$
